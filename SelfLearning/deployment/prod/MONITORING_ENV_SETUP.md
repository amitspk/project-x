...
- `GRAFANA_SERVER_ROOT_URL` - Grafana server URL for external access (default: `http://localhost:3000`)
...
GRAFANA_SERVER_ROOT_URL=http://localhost:3000  # Or https://grafana.yourdomain.com for prod
```
